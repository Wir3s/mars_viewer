export async function GET() {
  ...
  const manifestUrl = `https://api.nasa.gov/mars-photos/api/v1/manifests/curiosity?api_key=${apiKey}`;
  ...
  const url = `https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos?earth_date=${latestEarthDate}&api_key=${apiKey}`;
